...
//
// New chars 96=no signal, 126=battery flat, 127=battery low
// Modified from SSD1306Ascii font X11fixed7x14B
// New chars created with GLCD Font Creator 2: use a 6x14 size. But last 6 bytes for each char need >>2
// Note: Pixels are only six columns wide.
// Format: first 6 rows, vertically in each byte (bit 0 at top); next 6 rows vertically.(bit 0 at the top)
//
#ifndef X11fixed7x14B_with_low_battery_h
#define X11fixed7x14B_with_low_battery_h
GLCDFONTDECL(X11fixed7x14B_with_low_battery) = {
  ...
  0X22,0X14,0X08,0X14,0XA2,0X00,0X08,0X00,0X0E,0X00,0X0F,0X00,  // no signal
  ...
  0x00, 0xFC, 0x06, 0xF6, 0x06, 0xFC, 0x00, 0x1F, 0x10, 0x14, 0x10, 0x1F,  // bat empty
  0x00, 0xFC, 0x06, 0x06, 0x06, 0xFC, 0x00, 0x1F, 0x1C, 0x1C, 0x1C, 0x1F   // bat low
 };
